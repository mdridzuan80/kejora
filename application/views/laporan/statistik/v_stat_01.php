<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Laporan Statistik Lebih 3 Kali Lewat</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div id="lpr_param_stat_lewat">
        <div class="row">
            <?php
                ...
                echo form_open('laporan/stat_01', $attributes);
            ?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-sm-11">
                    		<a id="cmdJanaLaporan" class="btn btn-primary btn-sm" onclick="return rptStatLewat3xSubmit()" >Jana Laporan</a>
                        </div>
                    </div>
                </div>
            </form>
