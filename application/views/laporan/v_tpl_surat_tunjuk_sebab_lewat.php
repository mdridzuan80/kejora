    ...
    <table>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="450">&nbsp;</td>
            <td width="25%" align="right"><table width="210" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="70">Ruj. Kami </td>
                <td width="140" align="left">:&nbsp;</td>
              </tr>
              <tr>
                <td width="70">Tarikh</td>
                <td width="140" align="left">:&nbsp;<?php echo date('d') . ' ' . $dict_bulan[date('n')] . ' ' . date('Y') ?></td>
              </tr>
            </table></td>
            </tr>
        </table></td>
		  ...
		  ?>
           <table class="biasa">
            ...
            <tr>
              ...
              <td width="50%" valign="top">Lewat hadir ke pejabat</td>
            </tr>
            <?php }else{?>
            <tr>
              <td width="10%" valign="top"><p align="center"><?php echo strtoupper(date('d-m-Y', strtotime($rekod->rpt_tarikh)))?></p></td>
      ...
      <tr>
        <td><strong>(
			<?php if($dept_id != 29){?>
			<?php echo strtoupper($pegawai)?>
            <?php }else{ ?>
            <?php echo strtoupper('Noor Azlina Binti Yunus') ?>
            <?php } ?>
           	)</strong></td>
      </tr>
      <tr>
