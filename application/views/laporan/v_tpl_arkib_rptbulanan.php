...
<page style="font-size: 10px">
    ...
    <table style="width:100%">
    	<tr>
        	<td style="width:100%; text-align:center;"><img src="assets/images/logo.gif" /></td>
        </tr>
    </table>
	<table>
    	<tr>
        ...
        <?php
			$kod = pcrs_get_arkib_kod_warna_kad($row->USERID);
			switch($kod)
			{
				case 1:
					$kod_kad = 'KUNING';
    ...
    <table class="biasa">
        ...
        <tr <?php if(date("N", strtotime($val['tarikh']))==6 || date("N", strtotime($val['tarikh']))==7) echo "style=\"background-color:#EEE;\"" ?>>
            ...
            <td style="width:14%"><?php if($val['chkin']) echo date("g:i:s a", strtotime($val['chkin']))?></td>
            <td style="width:14%"><?php if($val['chkout']) echo date("g:i:s a", strtotime($val['chkout']))?></td>
            <td style="width:10%">
				<?php
                	if($val['chkin'])
					{
